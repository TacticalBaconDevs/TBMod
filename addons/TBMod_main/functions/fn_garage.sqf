...
switch _mode do {
    ...
    case "Open": {
        ...
        with uinamespace do {
            ...
            _displayClass = "TB_RscDisplayGarage";
...
*/
    ...
    case "Preload": {
        if (is3DEN) then {
            ...
            if (!isNil {missionnamespace getVariable "bis_fnc_garage_data"}) exitWith {true};
            
            if (isNil {missionnamespace getVariable "bis_fnc_garage_data"} || cheatsenabled) then {
                ["bis_fnc_garage_preload"] call bis_fnc_startloadingscreen;
...
*/
    ...
    case "SelectItem": {
        ...
        (_display displayctrl 44146) ctrlshow false;
        (_display displayctrl 44147) ctrlshow false;
        (_display displayctrl 44148) ctrlshow false;
        (_display displayctrl 44149) ctrlshow false;
        (_display displayctrl 44150) ctrlshow false;
        (_display displayctrl 44151) ctrlshow false;
        (_display displayctrl 44346) ctrlshow false;
        (_display displayctrl 44347) ctrlshow false;
        (_display displayctrl 44448) ctrlshow false;
        ...
        switch _idc do {
            ...
            case IDC_RSCDISPLAYGARAGE_TAB_STATIC: {
                ...
                if (_class != _centerType || !alive _center) then {
                    ...
                    if (_center != player && !(_center isKindOf "Helipad_base_F")) then {_center setpos [10,10,00];};
                    if !(_center isKindOf "Helipad_base_F") then {deletevehicle _center};
...
*/
    ...
    case "buttonRandom": {
        ...
        if (is3DEN) then {
            //-- Select random animations and textures
            {
                _ctrlList = _display displayctrl (IDC_RSCDISPLAYARSENAL_LIST + _x);
    ...
    case "buttonOK": {
        ...
        if (is3DEN) then {
            ...
            set3DENAttributes [[_objects,"VehicleCustomization",_customization]];
        };
