...
addMissionEventHandler ["EntityRespawned", {BIS_WL_allWarlords = BIS_WL_allWarlords - [_this # 1]; if ((side group _x) in [WEST, EAST]) then {BIS_WL_allWarlords pushBackUnique (_this # 0)}}];
