class TB_supply_usa_ammo : WRAPPER_NAME(Box_NATO_Ammo_F)
{
    ...
    { 
        MACRO_ADDMAGAZINE(uns_30Rnd_556x45_Stanag_T,40);    // Standart GewehrMag
        MACRO_ADDMAGAZINE(uns_thompsonmag_20_T,3);          // MGMag5.56
        MACRO_ADDMAGAZINE(uns_m1carbinemag_T,6);            // MGMag7.62
        MACRO_ADDMAGAZINE(uns_12gaugemag_6,10);             // DMRMag7.62
    };
};
