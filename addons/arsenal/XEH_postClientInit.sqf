...
// Arsenal Extrabutton
[
    ["ACE_fieldDressing", "ACE_packingBandage", "ACE_elasticBandage", "ACE_tourniquet", "ACE_splint", "ACE_morphine", "ACE_adenosine", "ACE_atropine", "ACE_epinephrine", "TB_med_thrombin", "ACE_plasmaIV",
        ...
        "ACE_surgicalKit", "ACE_bodyBag", "adv_aceCPR_AED", "TB_med_venenkatheter"],
    "Medical",
