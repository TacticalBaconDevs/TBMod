...
class TB_RscControlsGroupNoScrollbars : TB_RscControlsGroup {
...
class TB_RscListNBox
{
	...
	autoScrollDelay = 5;
	autoScrollRewind = 0;
	class ListScrollBar: TB_RscScrollBar{};
	class ScrollBar: TB_RscScrollBar{};
};
...
class TB_RscTextMulti : TB_RscText
{
	linespacing = 1;
	style = 0 + 16 + 0x200;
};
...
class TB_RscButtonTextOnly : TB_RscButton {
	SizeEx = "(			(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 0.8)";
	colorBackground[] = {1, 1, 1, 0};
...
class TB_RscButtonMenu : TB_RscShortcutButton {
	idc = -1;
	type = 16;
	style = "0x02 + 0xC0";
	default = 0;
...
class TB_RscShortcutButtonMain : TB_RscShortcutButton {
	idc = -1;
	style = 0;
	default = 0;
	w = 0.313726;
...
class TB_RscBackground : TB_RscText {
	type = 0;
	IDC = -1;
	style = 512;
	shadow = 0;
