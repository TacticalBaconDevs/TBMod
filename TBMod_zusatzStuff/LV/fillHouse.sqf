/*
            ...
            Calling the script:
                    ...
                    default: nul = [this] execVM "\TBMod_zusatzStuff\LV\fillHouse.sqf";
                    
                    custom:  nul = [target, side, patrol, patrol type, spawn rate, radius, skills, group, 
                                    custom init, ID, classes] execVM "\TBMod_zusatzStuff\LV\fillHouse.sqf";
...
EXAMPLE:     nul = [this, 2, true, 2, 50, 1, 0.75, nil, nil, 9, ["ALL"]] execVM "\TBMod_zusatzStuff\LV\fillHouse.sqf";
...
if(isNil("LV_classnames"))then{LV_classnames = TB_LV_fnc_classnames};
if(isNil("LV_validateClassArrays"))then{LV_validateClassArrays = TB_LV_fnc_validateClassArrays};
if(isNil("LV_ACskills"))then{LV_ACskills = compile preprocessFile "\TBMod_zusatzStuff\LV\functions\LV_fnc_ACskills.sqf";};
if(isNil("LV_vehicleInit"))then{LV_vehicleInit = compile preprocessFile "\TBMod_zusatzStuff\LV\functions\LV_fnc_vehicleInit.sqf";};
